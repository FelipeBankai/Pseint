	...
	Repetir
		...
		Segun entrada1 Hacer
		    ...
		    2:
			    Repetir
					Limpiar Pantalla;
				Escribir "Género de comedia";
				Escribir "1.Dagashi Kashi";
				Escribir "2.Gugure Kokkuri-san";
				Escribir "3.Watamote";
				Escribir "Presione 0 para volver";
				Leer op2;
				Limpiar Pantalla;
				Segun op2 Hacer
					1:
						Escribir "El padre de Shikada Kokonotsu posee una tienda de dulces en una zona rural, y su plan es que sea su hijo quien se encargue del negocio familiar algún día. Sin embargo, lo que Kokonotsu quiere realmente es ser autor de manga. Un día de verano aparece en la tienda Shidare Hotari, una preciosa pero rarita chica que pertenece a una famosa cadena de tiendas de dulces. Al haber escuchado de la fama del padre del protagonista, quiere que su local se una a la compañía de su familia. El padre sin embargo le dice que solo aceptará la oferta si convence a su hijo de que herede el negocio en el futuro.";
						Repetir
							Escribir "Presiona 0 para volver";
							Leer num;
						Hasta Que num=0
					2:
						Escribir "Basado en un manga 4-koma cómico de Midori Endo, la historia está protagonizada por Kohina, una niña pequeña que acaba invocando a un Kokkuri-san, un fantasma de bajo nivel del folclore japonés. El Kokkuri-san al que invoca es un hombre joven, guapo y de pelo blanco. Aunque al principio intenta asustar a la niña como debe, acaba preocupándose por ella y su mala costumbre de comer ramen en todas y cada una de las comidas, con lo que decide perseguirla para cuidar de ella.";
						Repetir
							Escribir "Presiona 0 para volver";
							Leer num;
						Hasta Que num=0
					3:
						Escribir "Kuroki Tomoko, una chica que tiene (50 años de experiencia) en citas y que ha salido con más de un centenar de chicos… en juegos otome.En la vida real acaba de cumplir 15 años y va a dar comienzo su época en el instituto, está convencida de que con sus conocimientos será la más popular. Una vez comienza el instituto, comienzan a pasar los días y se da cuenta de que no habla con nadie. ¿Cómo es posible? Un simple vistazo al espejo le hace darse cuenta de la realidad: no es precisamente una belleza y parece que hasta puede ser antipática.Poco a poco intentará cambiar para ser popular, pero claro, entre lo que le cuesta y lo que tiene una idea bastante distorsionada de la realidad, no será tan sencillo.";
						Repetir
							Escribir "Presiona 0 para volver";
							Leer num;
						Hasta Que num=0
		    ...
		    3:
				Repetir
					Limpiar Pantalla;
				Escribir "Género de terror";
				Escribir "1.Another";
				Escribir "2.Death Note";
				Escribir "3.Elfen Lied";
				Escribir "Presione 0 para volver";
				Leer op3;
				Limpiar Pantalla;
				Segun op3 Hacer
